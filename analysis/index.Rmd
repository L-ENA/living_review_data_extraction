...
This living review looks at data extraction methods for systematic review (semi)automation. On this website you will find information about the latest updates to the review, including [interactive maps](LatestUpdates.html) to filter and access review content, as well as additional information about [related publications](publications.html) and [authors](about.html) of this review and its software.
